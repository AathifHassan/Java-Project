...
public class Transaction {
    ...
    public String getTransactionDetails() {
        ...
        if (type == TransactionType.DEPOSIT) {
            msg = "Deposit of " + amount + " to " + toAccountNumber;  // Corrected for deposit (goes to "toAccountNumber")
        } else if (type == TransactionType.WITHDRAW) {
            msg = "Withdrawal of " + amount + " from " + fromAccountNumber;  // Corrected for withdrawal (comes from "fromAccountNumber")
        } else if (type == TransactionType.TRANSFER) {
            msg = "Transfer of " + amount + " from " + fromAccountNumber + " to " + toAccountNumber;  // Corrected for transfer (from "fromAccountNumber" to "toAccountNumber")
        }
